...
def bp(I,D,n_hidden,eta,n_max, plot="show plot"):
    np.random.seed(1926)
    ...
    for n in range(n_max):
        ...
        for k in range(n_examples):
            ...
            err_curve[n] = logloss_err_sum/n_examples
    
        
        #print('epoch %d: err %f'%(n,np.mean(logloss_err_sum)/n_examples))
